...
int main()
{
    ...
    while (ch == 'y')                           //通过选择语句实现部分功能
    {
        ...
        if (k < numOfPlayer1*400/2) 
        {
            cout<<"\t\t" << "\n   庄家胜利，对不起，玩家团队失败...\n\n     胜败乃兵家常事，如破产请付清欠款，未破产请取出余额，如需继续请重新来过～" << endl;
            goto cc;
        }
        else if (k > numOfPlayer1*400+numOfPlayer1*400/2)
        {
            cout<<"\n\t\t" << "   玩家团队胜利，恭喜击败庄家！\n\n\t\t你可以带走你的赌资，并获得赌王团队称号\n\t\t如想继续挑战请重新来过～" << endl;
            goto cc;
        }
        else 
        {
            ...
            if (ch == 'y')
            {
                cout<<"  感谢您再次回到56&78 21点，请再次输入您的姓名以便确定您的赌资归属，谢谢合作" << endl;
            }

            if (ch == 'n') 
            {
                cout << "      即使未能与庄家分出最后胜负，你依旧可以带走你的现有赌资，无论增减" << endl;
                cout << "  ==========================================================================" << endl<<endl;
            }
        }
    }
